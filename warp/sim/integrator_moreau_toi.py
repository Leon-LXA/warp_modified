...
def eval_dense_dt_batched(
    ...
    for i in range(0, n[tid]):
        c[start[tid] + i] = a[start[tid] + i] * dt
...
class SemiImplicitMoreauIntegrator:
    ...
    def simulate(
        self, model, state_in, state_out, dt, mu, requires_grad=True, update_mass_matrix=False, prox_iter=10, sigmoid_scale=500.0, max_torque=1000.0
    ):
        # eval mass matrix
        ...
        wp.launch(
            ...
            outputs=[state_in.body_ft_s, state_in.joint_tau],
            device=model.device,
        )
        ...
        # prox iteration
        self.eval_contact_forces(model, state_in, dt, mu, prox_iter, sigmoid_scale)
        ...
        wp.launch(
            ...
            outputs=[state_in.body_ft_s_1, state_in.joint_tau_1],
            device=model.device,
        )
    ...
    def eval_contact_quantities(self, model, state_in, dt):
        # construct J_c
        # kernel 16
        wp.launch(
            ...
            outputs=[model.Jc, model.c_body_vec, state_in.point_vec],
            device=model.device,
        )
        ...
        wp.launch(
            ...
            outputs=[state_in.Inv_M_times_Jc_t_1],
            device=model.device,
        )
        ...
        wp.launch(
            ...
            outputs=[state_in.Inv_M_times_Jc_t_2],
            device=model.device,
        )
        ...
        wp.launch(
            ...
            outputs=[state_in.Inv_M_times_Jc_t_3],
            device=model.device,
        )
        ...
        wp.launch(
            ...
            outputs=[state_in.Inv_M_times_Jc_t_4],
            device=model.device,
        )
        ...
        wp.launch(
            ...
            outputs=[state_in.Inv_M_times_Jc_t_5],
            device=model.device,
        )
        ...
        wp.launch(
            ...
            outputs=[state_in.Inv_M_times_Jc_t_6],
            device=model.device,
        )
        ...
        wp.launch(
            ...
            outputs=[state_in.Inv_M_times_Jc_t_7],
            device=model.device,
        )
        ...
        wp.launch(
            ...
            outputs=[state_in.Inv_M_times_Jc_t_8],
            device=model.device,
        )
        ...
        wp.launch(
            ...
            outputs=[state_in.Inv_M_times_Jc_t_9],
            device=model.device,
        )
        ...
        wp.launch(
            ...
            outputs=[state_in.Inv_M_times_Jc_t_10],
            device=model.device,
        )
        ...
        wp.launch(
            ...
            outputs=[state_in.Inv_M_times_Jc_t_11],
            device=model.device,
        )
        ...
        wp.launch(
            ...
            outputs=[state_in.Inv_M_times_Jc_t_12],
            device=model.device,
        )
        ...
        wp.launch(
            ...
            inputs=[
                ...
                model.articulation_Jc_start,
                model.articulation_dof_start,
                state_in.Inv_M_times_Jc_t_1,
                state_in.Inv_M_times_Jc_t_2,
                state_in.Inv_M_times_Jc_t_3,
                state_in.Inv_M_times_Jc_t_4,
                state_in.Inv_M_times_Jc_t_5,
                state_in.Inv_M_times_Jc_t_6,
                state_in.Inv_M_times_Jc_t_7,
                state_in.Inv_M_times_Jc_t_8,
                state_in.Inv_M_times_Jc_t_9,
                state_in.Inv_M_times_Jc_t_10,
                state_in.Inv_M_times_Jc_t_11,
                state_in.Inv_M_times_Jc_t_12,
            ],
            outputs=[state_in.Inv_M_times_Jc_t],
        )
        ...
        # compute Jc*(H^-1*h(tau)) * dt
        # kernel 9
        wp.launch(
            kernel=eval_dense_dt_batched,
            dim=model.articulation_count,
            inputs=[
    ...
    def eval_contact_forces(self, model, state_in, dt, mu, prox_iter, sigmoid_scale):
        # prox iteration
        # kernel 7
        wp.launch(
            kernel=prox_iteration_unrolled,
            dim=model.articulation_count,
            inputs=[model.G_mat, state_in.c_vec, mu, prox_iter],
        ...
        #     dim=model.articulation_count,
        #     inputs=[state_in.point_vec, model.G_mat, state_in.c_vec, mu, prox_iter, sigmoid_scale],
        #     outputs=[state_in.percussion],
        #     device=model.device,
        # )
        ...
        wp.launch(
            kernel=p_to_f_s,
            dim=model.articulation_count,
            inputs=[model.c_body_vec, state_in.point_vec, state_in.percussion, dt],
